...
---@param collisionobject string|hash|url collision object where the joint exist
---@param joint_id string|hash id of the joint
---@return table properties properties table. See the joint types for what fields are available, the only field available for all types is:
---
---boolean collide_connected: Set this flag to true if the attached bodies should collide.
---
...
---@return table table A table containing meta data about the physics shape
---
---type
